...
export const NobleSupportSkills = [
  ...
  {
    type: "Support (Noble)",
    name: "Nether Grasp: Extermination (Noble)",
    tags: ["Erosion"],
    description: [
      "Supports Nether Grasp.\nThis skill can only be installed in the fifth Support Skill Slot of each Active Skill.\n+20% additional damage for the supported skill\nThe supported skill's abyssal hands become fan-shaped\n+20% additional damage taken by enemies in the center area of the supported skill's abyssal zone",
      "The supported skill's abyssal hands become fan-shaped\n+20% additional damage taken by enemies in the center area of the supported skill's abyssal zone",
      "+(25–29)% additional damage for the supported skill",
    ],
  ...
  {
    type: "Support (Noble)",
    name: "Fallen Star: Starfall (Noble)",
    tags: ["Physical"],
    description: [
      "Supports Fallen Star.\nThis skill can only be installed in the fifth Support Skill Slot of each Active Skill.\n+20% additional damage for the supported skill\nGains 1 stack of charge when the supported skill hits an enemy\nAt 50 stacks, consumes all charges and releases an additional annihilation wave",
      "Gains 1 stack of charge when the supported skill hits an enemy\nAt 50 stacks, consumes all charges and releases an additional annihilation wave",
      "+(130–150)% additional damage for the annihilation wave released by the supported skill",
    ],
  ...
  {
    type: "Support (Noble)",
    name: "Fallen Star: Gravity (Noble)",
    tags: ["Physical"],
    description: [
      "Supports Fallen Star.\nThis skill can only be installed in the fifth Support Skill Slot of each Active Skill.\n+20% additional damage for the supported skill\nThe supported skill's Meteor zone moves forward\n+50% Skill Area for the supported skill",
      "The supported skill's Meteor zone moves forward\n+50% Skill Area for the supported skill",
  ...
  {
    type: "Support (Noble)",
    name: "Thornfield: Retribution (Noble)",
    tags: ["Physical"],
    description: [
      "Supports Thornfield.\nThis skill can only be installed in the fifth Support Skill Slot of each Active Skill.\n+20% additional damage for the supported skill\nWhile standing in the domain generated by the supported skill, the character takes 10% of Max Life and 10% of Max Energy Shield as True Damage per second",
      "While standing in the domain generated by the supported skill, the character takes 10% of Max Life and 10% of Max Energy Shield as True Damage per second",
      "While standing in the domain generated by the supported skill, +(24–26)% additional damage for the supported skill every 0.5 s. Stacks up to 3 time(s)",
    ],
  ...
  {
    type: "Support (Noble)",
    name: "Storm Field: Conduction (Noble)",
    tags: ["Lightning"],
    description: [
      "Supports Storm Field.\nThis skill can only be installed in the fifth Support Skill Slot of each Active Skill.\n+20% additional damage for the supported skill\n+5 max targets that can be hit by the supported skill's current",
      "+5 max targets that can be hit by the supported skill's current",
      "The supported skill's current now grants +(6.5–7.0)% additional damage for every enemy hit instead",
    ],
  ...
  {
    type: "Support (Noble)",
    name: "Tidewell: Undertow (Noble)",
    tags: ["Cold"],
    description: [
      "Supports Tidewell.\nThis skill can only be installed in the fifth Support Skill Slot of each Active Skill.\n+20% additional damage for the supported skill\nFor every 2 stacks of Terra Charge consumed by the supported skill, +1 torrent, up to +2\nFor every 1 stack of Terra Charge consumed by the supported skill, +20% chance to inflict Slow on hit",
      "For every 2 stacks of Terra Charge consumed by the supported skill, +1 torrent, up to +2\nFor every 1 stack of Terra Charge consumed by the supported skill, +20% chance to inflict Slow on hit",
      "(-6–-3)% additional damage for the supported skill",
    ],
