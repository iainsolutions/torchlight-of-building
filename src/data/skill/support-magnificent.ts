...
export const MagnificentSupportSkills = [
  ...
  {
    type: "Support (Magnificent)",
    name: "Nether Grasp: Devour (Magnificent)",
    tags: ["Erosion"],
    description: [
      "Supports Nether Grasp.\nThis skill can only be installed in the third Support Skill Slot of each Active Skill.\n+20% additional damage for the supported skill\nWhen the supported skill defeats an enemy in the center area of the abyssal zone, +8% additional Skill Area for the supported skill for 4 s. Stacks up to 5 time(s)",
      "When the supported skill defeats an enemy in the center area of the abyssal zone, +8% additional Skill Area for the supported skill for 4 s. Stacks up to 5 time(s)",
      "+6% additional damage for the supported skill for every enemy in the center area of the abyssal zone, up to +30%",
    ],
    supportTarget: "Nether Grasp",
    manaCostMultiplierPct: 110,
  },
  {
    type: "Support (Magnificent)",
    name: "Haunting Abomination: Ravage (Magnificent)",
    tags: ["Erosion"],
    description: [
      "Supports Haunting Abomination.\nThis skill can only be installed in the third Support Skill Slot of each Active Skill.\n+20% additional damage for the supported skill\nWhen the supported skill's Haunting Terra deals damage while Spell Burst Charge is at max stacks, consumes all stacks of Spell Burst Charge. +100% additional Hit Damage for that instance of damage for every 1 stack(s) of Spell Burst Charge consumed",
      "When the supported skill's Haunting Terra deals damage while Spell Burst Charge is at max stacks, consumes all stacks of Spell Burst Charge. +100% additional Hit Damage for that instance of damage for every 1 stack(s) of Spell Burst Charge consumed",
      "+(32–36)% additional damage for the supported skill",
    ],
    supportTarget: "Haunting Abomination",
    manaCostMultiplierPct: 110,
  },
  {
    type: "Support (Magnificent)",
    name: "Fallen Star: Crush (Magnificent)",
    tags: ["Physical"],
    description: [
      "Supports Fallen Star.\nThis skill can only be installed in the third Support Skill Slot of each Active Skill.\n+20% additional damage for the supported skill\nWhen the supported skill drops comets while Spell Burst Charge is at max stacks, consumes all stacks of Spell Burst Charge. +100% additional Hit Damage for that wave of comets for every 1 stack(s) of Spell Burst Charge consumed",
      "When the supported skill drops comets while Spell Burst Charge is at max stacks, consumes all stacks of Spell Burst Charge. +100% additional Hit Damage for that wave of comets for every 1 stack(s) of Spell Burst Charge consumed",
      "+(32–36)% additional damage for the supported skill",
    ],
    supportTarget: "Fallen Star",
    manaCostMultiplierPct: 110,
  },
  {
    type: "Support (Magnificent)",
    name: "Thornfield: Sacrifice (Magnificent)",
    tags: ["Physical"],
    description: [
      "Supports Thornfield.\nThis skill can only be installed in the third Support Skill Slot of each Active Skill.\n+20% additional damage for the supported skill\nGains 1 stack of buff for every 20% of Max Life taken as damage, and has a 10% chance to gain 1 stack of buff when reaping an elite enemy within the domain generated by the supported skill\nFor every stack of buff, +2% additional damage (multiplies) for the supported skill and +1% Life Recovery Speed\nThe buff lasts for 5 s and stacks up to 10 time(s)",
      "Gains 1 stack of buff for every 20% of Max Life taken as damage, and has a 10% chance to gain 1 stack of buff when reaping an elite enemy within the domain generated by the supported skill\nFor every stack of buff, +2% additional damage (multiplies) for the supported skill and +1% Life Recovery Speed\nThe buff lasts for 5 s and stacks up to 10 time(s)",
      "+(8–11)% additional damage for the supported skill",
    ],
    supportTarget: "Thornfield",
    manaCostMultiplierPct: 110,
  },
  {
    type: "Support (Magnificent)",
    name: "Storm Field: Thunderclap (Magnificent)",
    tags: ["Lightning"],
    description: [
      "Supports Storm Field.\nThis skill can only be installed in the third Support Skill Slot of each Active Skill.\n+20% additional damage for the supported skill\nWhen the supported skill generates a current while Spell Burst Charge is at max stacks, consumes all stacks of Spell Burst Charge. +167% additional damage for that lightning bolt for every 1 stack(s) of Spell Burst Charge consumed",
      "When the supported skill generates a current while Spell Burst Charge is at max stacks, consumes all stacks of Spell Burst Charge. +167% additional damage for that lightning bolt for every 1 stack(s) of Spell Burst Charge consumed",
      "+(32–36)% additional damage for the supported skill",
    ],
    supportTarget: "Storm Field",
    manaCostMultiplierPct: 110,
  },
  {
    type: "Support (Magnificent)",
    name: "Tidewell: Torrent (Magnificent)",
    tags: ["Cold"],
    description: [
      "Supports Tidewell.\nThis skill can only be installed in the third Support Skill Slot of each Active Skill.\n+20% additional damage for the supported skill\nWhen the supported skill erupts torrents while Spell Burst Charge is at max stacks, consumes all stacks of Spell Burst Charge. +100% additional Hit Damage for those torrents for every 1 stack(s) of Spell Burst Charge consumed",
      "When the supported skill erupts torrents while Spell Burst Charge is at max stacks, consumes all stacks of Spell Burst Charge. +100% additional Hit Damage for those torrents for every 1 stack(s) of Spell Burst Charge consumed",
      "+(32–36)% additional damage for the supported skill",
    ],
    supportTarget: "Tidewell",
    manaCostMultiplierPct: 110,
  },
