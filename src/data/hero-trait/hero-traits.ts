...
export const HeroTraits = [
  ...
  },
  {
    ...
    level: 75,
    affix:
      "Level 1Heat Up gains an additional effect: For every stack of Heat Up, 0.4% additional Attack and Cast SpeedLevel 2Heat Up gains an additional effect: For every stack of Heat Up, 0.4% additional Attack and Cast Speed\n+5% additional damageLevel 3Heat Up gains an additional effect: For every stack of Heat Up, 0.4% additional Attack and Cast Speed\n+10% additional damageLevel 4Heat Up gains an additional effect: For every stack of Heat Up, 0.4% additional Attack and Cast Speed\n+16% additional damageLevel 5Heat Up gains an additional effect: For every stack of Heat Up, 0.4% additional Attack and Cast Speed\n+21% additional damage",
  },
  {
  ...
  },
  {
    ...
    level: 75,
    affix:
      "When inflicting Desecration on an Elite for the first time, deals True Damage equal to (6/8/10/12/15)% of Max Life\nWhen a Desecrated target is under a crowd control effect, the target gains Mountain of Sins",
  },
  {
    hero: "Oracle Thea: Blasphemer (#3)",
  ...
  },
  {
    ...
    level: 1,
    affix:
      "Level 1Within 4 s after a Summon Skill is cast, all your Minions will gain Overload. Cooldown: 12 s\nOverload grants +60% additional damage\nThe Effect and Duration of Overload are refreshed when a Minion that already has Overload gains Overload again\n模组化技能的冷却时间降低至 0.1 秒Level 2Within 4 s after a Summon Skill is cast, all your Minions will gain Overload. Cooldown: 12 s\nOverload grants +60% additional damage\nThe Effect and Duration of Overload are refreshed when a Minion that already has Overload gains Overload again\n+5% additional damage when Minions have Overload\n模组化技能的冷却时间降低至 0.1 秒Level 3Within 4 s after a Summon Skill is cast, all your Minions will gain Overload. Cooldown: 12 s\nOverload grants +60% additional damage\nThe Effect and Duration of Overload are refreshed when a Minion that already has Overload gains Overload again\n+10% additional damage when Minions have Overload\n模组化技能的冷却时间降低至 0.1 秒Level 4Within 4 s after a Summon Skill is cast, all your Minions will gain Overload. Cooldown: 12 s\nOverload grants +60% additional damage\nThe Effect and Duration of Overload are refreshed when a Minion that already has Overload gains Overload again\n+16% additional damage when Minions have Overload\n模组化技能的冷却时间降低至 0.1 秒Level 5Within 4 s after a Summon Skill is cast, all your Minions will gain Overload. Cooldown: 12 s\nOverload grants +60% additional damage\nThe Effect and Duration of Overload are refreshed when a Minion that already has Overload gains Overload again\n+22% additional damage when Minions have Overload\nArtificial Moon:\n+30% Overload Duration\n模组化技能的冷却时间降低至 0.1 秒",
  },
  {
    hero: "Commander Moto: Order Calling (#1)",
    name: "Veteran",
  ...
  // === SS13 Selena Rework: Dance of the Deep (#2) ===
  {
    hero: "Tide Whisper Selena: Dance of the Deep (#2)",
    name: "Dance of the Deep",
    level: 1,
    affix:
      "Level 1The Main Terra Skill is always centered on you and follows you as you move\nNon-Main Terra Skills cannot deal damageLevel 2The Main Terra Skill is always centered on you and follows you as you move\nNon-Main Terra Skills cannot deal damage\n+5% additional Terra Skill DamageLevel 3The Main Terra Skill is always centered on you and follows you as you move\nNon-Main Terra Skills cannot deal damage\n+10% additional Terra Skill DamageLevel 4The Main Terra Skill is always centered on you and follows you as you move\nNon-Main Terra Skills cannot deal damage\n+15% additional Terra Skill DamageLevel 5The Main Terra Skill is always centered on you and follows you as you move\nNon-Main Terra Skills cannot deal damage\n+20% additional Terra Skill Damage\nArtificial Moon (variants):\nTerra Conductor: increases the damage provided by Terra Skills to 32% for every 1 Terra Charge they consume (per tlidb launch data)\nRed Shoes of Cruelty: While a Main Terra Skill is active, you take True Damage per second equal to a percentage of Max Life and Energy Shield; this percentage equals 8% of your Movement Speed bonus, up to 15%\nEnemies within the Main Terra Skill's area take increased damage equal to 38% of your Movement Speed bonus, up to 75%",
  },
  {
    hero: "Tide Whisper Selena: Dance of the Deep (#2)",
    name: "The Paradise I Curse",
    level: 45,
    affix:
      "Enemies within the range of your Main Terra Skill receive a Lv. 1 Ominous Curse\n(+10/+15/+20/+25/+30)% additional damage against enemies affected by Ominous Curse",
  },
  {
    hero: "Tide Whisper Selena: Dance of the Deep (#2)",
    name: "The Cycle I Resist",
    level: 45,
    affix:
      "25% of the increase/decrease on Critical Strike Rating is also applied to the Duration of your Main Terra Skill\nRecasting your Main Terra Skill while the previous one is still active Reaps enemies within its range for (6/7/8/9/10)% of the skill's remaining Duration",
  },
  {
    hero: "Tide Whisper Selena: Dance of the Deep (#2)",
  ...
  },
  {
    ...
    level: 60,
    affix:
      "(+50/+75/+100/+125/+150)% Terra Charge Restoration Speed\nThe increase/decrease on Max Spell Burst is also applied to Max Terra Charge Stacks, up to (+2/+2/+3/+3/+3)",
  },
  {
    hero: "Tide Whisper Selena: Dance of the Deep (#2)",
    ...
    level: 60,
    affix:
      "When casting your Main Terra Skill, summons 1 Crimson Shade within its area for every 1 Max Spell Burst. Interval: 1 s\nUp to (1/1/2/2/3) Crimson Shade(s) can exist at the same time\n(-60/-50/-50/-40/-40)% additional damage for Terra Skills cast by Crimson Shades\nCrimson Shades are stationary and cast your Main Terra Skill once, centered on themselves, then disappear after the skill ends",
  },
  {
    hero: "Tide Whisper Selena: Dance of the Deep (#2)",
    ...
    level: 60,
    affix:
      "When casting your Main Terra Skill, randomly enters a Dance Step stance that lasts (5/6/7/8/9) s. Interval: (5/5/4.5/4.5/4) s\nDance Step duration is affected by Skill Effect Duration bonuses\nCrimson Dash: +33% Movement Speed\nAgonizing Revival: Regenerates 13% of Max Life and Max Energy Shield per second\nEternal Sleep: Enemies that stay within the Main Terra Skill's area for more than 0.5 s fall into Eternal Sleep for 2 s, taking +66% additional damage and becoming unable to move or attack. Eternal Sleep ends early after the enemy takes damage equal to 30% of its Max Life and can trigger at most once per monster",
  },
  {
    hero: "Tide Whisper Selena: Dance of the Deep (#2)",
    name: "Silencing Severance",
    level: 75,
    affix:
      "Max Terra Charge Stacks +1\nYour Main Terra Skill is automatically supported by Activation Medium: Terra and cannot be supported by other Catalyst skills\nCompensates (0/5/10/15/20)% of the Mana Sealed by Activation Medium: Terra",
  },
  {
    hero: "Tide Whisper Selena: Dance of the Deep (#2)",
    name: "Drenched Hem",
    level: 75,
    affix:
      "Activation Medium: Terra Seals Life instead of Mana\nFor every 3% of Life Sealed, (+1/1.2/1.4/1.6/1.8)% additional damage for your Main Terra Skill",
  },
  {
  ...
  },
  {
    ...
    level: 60,
    affix:
      "(+24/+27/+30/+33/+36)% additional Elixir Skill Effect after casting (6/6/5/4/3) Elixir Skill(s). Lasts for 4 s\n-30% additional Elixir Skill Effect Duration",
  },
  {
    hero: "Scent Weaver Sage: Licorice Note (#1)",
  ...
  },
  {
    ...
    level: 75,
    affix:
      "Level 1Obtain a Special Scent Bottle, which can be used to concoct Elixir Skills. The third Active Skill slot is treated as the Special Scent Bottle\nElixir Skills from Special Scent Bottles can be equipped with 1 Ingredient to gain its corresponding additional Base EffectsSpecial IngredientPixie Tear: This skill gains an additional base effect: 80% of excess Life restoration is also applied to Energy Shield restoration, but is unable to Charge or Regain Energy Shield. For every 400 Max Energy Shield, +1% additional damage for you and your Minions, up to +40% (not affected by the effects of Elixir Skills)Thunder Dragon Scale: This skill gains an additional base effect: When defeated by your or your Minions' Attacks or Spells, enemies have a 30% chance to explode, dealing True Damage equal to 250% of their Max Life to enemies within a 6 m radius (not affected by the effects of Elixir Skills)Gargoyle Horn: This skill gains an additional base effect: Increases Block Chance by an additional 70% , but you take True Damage equal to 6% of the mitigated damage every second after each successful block. Lasts for 4s (not affected by the effects of Elixir Skills)Level 2Obtain a Special Scent Bottle, which can be used to concoct Elixir Skills. The third Active Skill slot is treated as the Special Scent Bottle\nElixir Skills from Special Scent Bottles can be equipped with 1 Ingredient to gain its corresponding additional Base EffectsSpecial IngredientPixie Tear: This skill gains an additional base effect: 90% of excess Life restoration is also applied to Energy Shield restoration, but is unable to Charge or Regain Energy Shield. For every 400 Max Energy Shield, 1.2% additional damage for you and your Minions, up to +48% (not affected by the effects of Elixir Skills)Thunder Dragon Scale: This skill gains an additional base effect: When defeated by your or your Minions' Attacks or Spells, enemies have a 30% chance to explode, dealing True Damage equal to 6 of their Max Life to enemies within a 250% m radius. + 5% additional damage for you and your Minions (not affected by the effects of Elixir Skills)Gargoyle Horn: This skill gains an additional base effect: Increases Block Chance by an additional 90% , but you take True Damage equal to 4.5% of the mitigated damage every second after each successful block. Lasts for 4s (not affected by the effects of Elixir Skills)Level 3Obtain a Special Scent Bottle, which can be used to concoct Elixir Skills. The third Active Skill slot is treated as the Special Scent Bottle\nElixir Skills from Special Scent Bottles can be equipped with 1 Ingredient to gain its corresponding additional Base EffectsSpecial IngredientPixie Tear: This skill gains an additional base effect: 100% of excess Life restoration is also applied to Energy Shield restoration, but is unable to Charge or Regain Energy Shield. For every 400 Max Energy Shield, 1.4% additional damage for you and your Minions, up to +56% (not affected by the effects of Elixir Skills)Thunder Dragon Scale: This skill gains an additional base effect: When defeated by your or your Minions' Attacks or Spells, enemies have a 30% chance to explode, dealing True Damage equal to 6 of their Max Life to enemies within a 250% m radius. + 10% additional damage for you and your Minions (not affected by the effects of Elixir Skills)Gargoyle Horn: This skill gains an additional base effect: Increases Block Chance by an additional 110% , but you take True Damage equal to 3% of the mitigated damage every second after each successful block. Lasts for 4s (not affected by the effects of Elixir Skills)Level 4Obtain a Special Scent Bottle, which can be used to concoct Elixir Skills. The third Active Skill slot is treated as the Special Scent Bottle\nElixir Skills from Special Scent Bottles can be equipped with 1 Ingredient to gain its corresponding additional Base EffectsSpecial IngredientPixie Tear: This skill gains an additional base effect: 110% of excess Life restoration is also applied to Energy Shield restoration, but is unable to Charge or Regain Energy Shield. For every 400 Max Energy Shield, 1.6% additional damage for you and your Minions, up to +62% (not affected by the effects of Elixir Skills)Thunder Dragon Scale: This skill gains an additional base effect: When defeated by your or your Minions' Attacks or Spells, enemies have a 30% chance to explode, dealing True Damage equal to 6 of their Max Life to enemies within a 250% m radius. + 15% additional damage for you and your Minions (not affected by the effects of Elixir Skills)Gargoyle Horn: This skill gains an additional base effect: Increases Block Chance by an additional 130% , but you take True Damage equal to 1.5% of the mitigated damage every second after each successful block. Lasts for 4s (not affected by the effects of Elixir Skills)Level 5Obtain a Special Scent Bottle, which can be used to concoct Elixir Skills. The third Active Skill slot is treated as the Special Scent Bottle\nElixir Skills from Special Scent Bottles can be equipped with 1 Ingredient to gain its corresponding additional Base EffectsSpecial IngredientPixie Tear: This skill gains an additional base effect: 120% of excess Life restoration is also applied to Energy Shield restoration, but is unable to Charge or Regain Energy Shield. For every 400 Max Energy Shield, 1.8% additional damage for you and your Minions, up to +70% (not affected by the effects of Elixir Skills)Thunder Dragon Scale: This skill gains an additional base effect: When defeated by your or your Minions' Attacks or Spells, enemies have a 30% chance to explode, dealing True Damage equal to 6 of their Max Life to enemies within a 250% m radius. + 20% additional damage for you and your Minions (not affected by the effects of Elixir Skills)Gargoyle Horn: This skill gains an additional base effect: Increases Block Chance by an additional 150% , but you take True Damage equal to 0% of the mitigated damage every second after each successful block. Lasts for 4s (not affected by the effects of Elixir Skills)",
  },
