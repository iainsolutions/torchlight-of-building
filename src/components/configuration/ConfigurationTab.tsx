      ...
      <div className="rounded-lg border border-zinc-700 bg-zinc-900 p-6">
        <div className="grid w-fit grid-cols-[auto_auto] items-center gap-x-3 gap-y-2">
          ...
          <input
            ...
            onChange={(e) => onUpdate({ targetEnemyIsElite: e.target.checked })}
            className="h-4 w-4 rounded border-zinc-600 bg-zinc-800 accent-amber-500"
          />
          ...
          <label className="text-right text-zinc-50">Enemy Has Trauma</label>
          <input
            type="checkbox"
            checked={config.enemyHasTrauma}
            onChange={(e) => onUpdate({ enemyHasTrauma: e.target.checked })}
            className="h-4 w-4 rounded border-zinc-600 bg-zinc-800 accent-amber-500"
          />
          ...
          <label className="text-right text-zinc-50">Is Moving</label>
          <input
            type="checkbox"
            checked={config.isMoving}
            onChange={(e) => onUpdate({ isMoving: e.target.checked })}
            className="h-4 w-4 rounded border-zinc-600 bg-zinc-800 accent-amber-500"
          />

          <label className="text-right text-zinc-50">Not Hit Recently</label>
          <input
            type="checkbox"
            checked={config.notHitRecently}
            onChange={(e) => onUpdate({ notHitRecently: e.target.checked })}
            className="h-4 w-4 rounded border-zinc-600 bg-zinc-800 accent-amber-500"
          />
